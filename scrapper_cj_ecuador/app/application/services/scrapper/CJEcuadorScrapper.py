...
class CJEcuadorScrapper(ICJEcuadorScrapper):

    
  
    def __init__(self,db: IDataBase,repository:RadicadoProcesadoCJRepository, getData: IGetDataService, processData: IProcessDataService,publish_actuaciones:IActuacionesPublishService):
        self.db=db
